...
## Usage
If you're using Thunderstore, adjust in autogenerated config file. If you're using LethalConfig, hit escape and edit in the game.

# Potential Conflicts Note
Some mods offer the capability to modify the behavior of Brackens, and I don't know how this influences the behavior with this mod. Create an issue with the conflicting mod, and depending on its adoption (# of downloads), I'll add compatibility.
